<div class="main-content">
    <section class="section">
        ...
        <div class="card" style="width: 55%; text-align: center;">
            <div class="card-header">Konfirmasi Pembayaran</div>
            <div class="card-body">
                <form method="POST" action="<?= base_url('admin/Transaksi/cekPembayaran'); ?>">
                    <?php foreach ($pembayaran as $pmb) : ?>
                        <a class="btn btn-sm btn-success" href="<?= base_url('admin/Transaksi/downloadPembayaran/' . $pmb->id_rental); ?>"><i class="fas fa-download"></i>Download Bukti Pembayaran</a>
